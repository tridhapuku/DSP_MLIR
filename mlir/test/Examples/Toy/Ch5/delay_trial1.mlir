...
// toy.func @main() {
//   %0 = toy.constant dense<[[1.000000e+00, 2.000000e+00, 3.000000e+00 ,4.000000e+00, 
//           5.000000e+00, 6.000000e+00]]> : tensor<1x6xf64>
//   // toy.print %0 : tensor<1x6xf64>
//   //try binary operation -- add or mult
//   %3 = toy.mul %0, %0 : tensor<1x6xf64>
//   toy.print %3 : tensor<1x6xf64>

//   // try transpose
// //   %4 = toy.transpose(%0 : tensor<1x6xf64>) to tensor<6x1xf64>
// //   toy.print %4 : tensor<6x1xf64>
//   toy.return
// }
...
//   // toy.print %0 : tensor<6xf64>
//   toy.print %1 : tensor<f64>
//   toy.return
// }

// toy.func @main() {
//   %0 = toy.constant dense<[1.000000e+01, 2.000000e+01, 3.000000e+01, 4.000000e+01, 5.000000e+01, 6.000000e+01]> : tensor<6xf64>
//   %1 = toy.constant dense<2.000000e+00> : tensor<f64>
//   toy.print %0 : tensor<6xf64>
//   toy.print %1 : tensor<f64>
//   toy.return
...
//   %0 = toy.constant dense<[1.000000e+01, 2.000000e+01, 3.000000e+01, 4.000000e+01, 5.000000e+01, 6.000000e+01]> : tensor<6xf64>
//   %1 = toy.constant dense<2.000000e+00> : tensor<f64>
//   %2 = "toy.delay"(%0, %1) : (tensor<6xf64>, tensor<f64>) -> tensor<6xf64>
//   toy.print %0 : tensor<6xf64>
//   toy.print %1 : tensor<f64>
