...
module {
  func.func @test_fft2d(%arg0: memref<1x4x8xf32>, %arg1: memref<1x4x8xf32>) -> (memref<1x4x8xf32>, memref<1x4x8xf32>) {
    %cst = arith.constant 8.000000e+00 : f32
    %cst_0 = arith.constant 4.000000e+00 : f32
    %cst_1 = arith.constant 6.28318548 : f32
    %cst_2 = arith.constant 0.000000e+00 : f32
    // %0 = tensor.empty() : memref<1x4x8xf32>
    %0 = tensor.empty() : tensor<1x4x8xf32>
    %1 = linalg.fill ins(%cst_2 : f32) outs(%0 : memref<1x4x8xf32>) -> memref<1x4x8xf32>
    %2 = tensor.empty() : tensor<1x4x8xf32>
    %3 = linalg.fill ins(%cst_2 : f32) outs(%2 : memref<1x4x8xf32>) -> memref<1x4x8xf32>
    %4:2 = linalg.generic {indexing_maps = [#map, #map, #map1, #map1], iterator_types = ["parallel", "parallel", "parallel", "reduction", "reduction"]} ins(%arg0, %arg1 : memref<1x4x8xf32>, memref<1x4x8xf32>) outs(%1, %3 : memref<1x4x8xf32>, memref<1x4x8xf32>) {
    ...
    } -> (memref<1x4x8xf32>, memref<1x4x8xf32>)
    return %4#0, %4#1 : memref<1x4x8xf32>, memref<1x4x8xf32>
  }
}
