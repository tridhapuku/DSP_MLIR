...
module {
  dsp.func @main() {
    // %0 = dsp.constant dense<[1.000000e+01, 2.000000e+01, 3.000000e+01, 4.000000e+01, 5.000000e+01, 6.000000e+01, 7.000000e+01, 8.000000e+01, 9.000000e+01, 1.000000e+02]> : tensor<10xf64>
    %0 = dsp.constant dense<[1.000000e+01, 2.000000e+01, 3.000000e+01, 4.000000e+01, 5.000000e+01, 6.000000e+01, 7.000000e+01, 8.000000e+01, 9.000000e+01, 1.000000e+02]> : tensor<10xf64>
    %1 = dsp.constant dense<1.000000e+01> : tensor<f64>
    %2 = dsp.hamming(%1 : tensor<f64>) to tensor<*xf64>
    %3 = dsp.mul %0, %2 : (tensor<10xf64>, tensor<*xf64>) -> tensor<*xf64>
    // %real, %img = dsp.fft1d(%3 : tensor<10xf64>) to (tensor<*xf64>, tensor<*xf64>)
    %real, %img = dsp.fft1d(%3 : tensor<*xf64>) to (tensor<*xf64>, tensor<*xf64>)
    // %sq = dsp.mul %real, %real: (tensor<*xf64>, tensor<*xf64>) -> tensor<*xf64>
    %sq = dsp.square(%real : tensor<*xf64>) to tensor<*xf64>
    // // take mean for periodogram
    // %sum = dsp.sum(%sq : tensor<*xf64>) to tensor<*xf64>
    // %divByN = dsp.div %sq, %1 : (tensor<*xf64>, tensor<f64>) -> tensor<*xf64>
    // dsp.print %sq : tensor<10xf64>
    dsp.print %sq : tensor<*xf64>
    // dsp.print %real : tensor<*xf64>
